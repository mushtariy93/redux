...
const Login = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-[url('https://as1.ftcdn.net/v2/jpg/10/31/33/04/1000_F_1031330476_ZzgJyPN8rOey8hCgmTgTcdtlvw22MIed.jpg')]">
      <form
